...
class NewsAPI():
    def __init__(self):
        ...
        self.news_sources = ["reuters", "cnn", "the-guardian-uk", "the-new-york-times", "bbc-news", "daily-mail", "the-economist", "business-insider", "independent", "fortune", "time", "bbc-sport"]
